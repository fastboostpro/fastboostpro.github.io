...
var uaSet = {
	titleText: 'Увага!',
	alertStart: 'Увага!\n\nВаш телефон '+ device_brand +' може працювати повільно.',
	alertBack: 'Почекайте!\n\nВаш телефон все ще може працювати повільно.\n\nЗалишайтесь на сторінці та встановіть цей рекомендований для телефонів '+ device_brand +' додаток прямо зараз.',	
	header: 'Ваш телефон '+ device_brand +' може бути засмічений зайвими файлами!',
	text1: 'Швидкість Вашого телефона '+ device_brand +' може бути знижена і його пам\'ять може бути засмічена.</b>',
	text2: 'Очистіть Ваш телефон, щоб прискорити його.</b>',
	text3: 'Встановіть <strong>БЕЗКОШТОВНИЙ</strong> додаток '+ app_name +', щоб очистити ваш '+ device_brand +' прямо зараз!',
	button: 'Встановити'
};
